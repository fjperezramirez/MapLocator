...
//        for(var i = 0; i < lstFeaturesWithCount.GetItemCount(); i++){
//            s1[i] = lstFeaturesWithCount[i].Count;
//        }
...
//        var ticks = [];
//        for(var i = 0; i < lstFeaturesWithCount.GetItemCount(); i++){
//            ticks[i] = lstFeaturesWithCount[i].Name;
//        }
//        
...
function FillSampleChart(chartId) {
...
//            ticks[i] = lstFeaturesWithCount[i].Name;
        //        }
        var ticks = ['Asesinato', 'Robos', 'Vehiculo Hurtado', 'Escalamientamiento'];
